    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <textarea name="content" class="form-control editor" rows="12">{{ $page['content'] ?? '' }}</textarea>
                <small class="text-muted">HTML permitido</small>
            </div>
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">Imagem de Destaque (URL)</label>
                    <input type="text" name="featured_image" class="form-control" value="{{ $page['featured_image'] ?? '/assets/images/empresa.jpg' }}">
                </div>
                <div class="col-md-6">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <textarea name="missao" class="form-control" rows="4">{{ $sectionMap['missao'] ?? '' }}</textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Visão</label>
                    <textarea name="visao" class="form-control" rows="4">{{ $sectionMap['visao'] ?? '' }}</textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Valores</label>
                    <textarea name="valores" class="form-control" rows="4">{{ $sectionMap['valores'] ?? '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
