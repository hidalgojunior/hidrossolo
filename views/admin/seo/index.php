    ...
    <div class="card-body">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="site_title" class="form-control" value="<?= e($settings['site_title'] ?? $config['seo']['title'] ?? '') ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Meta Description</label>
                    <input type="text" name="meta_description" class="form-control" value="<?= e($settings['meta_description'] ?? '') ?>" maxlength="160">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="og_title" class="form-control" value="<?= e($settings['og_title'] ?? '') ?>">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="og_description" class="form-control" rows="2"><?= e($settings['og_description'] ?? '') ?></textarea>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="google_verification" class="form-control" value="<?= e($settings['google_verification'] ?? '') ?>">
                </div>
            </div>
