...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        body{font-family:var(--font-sans);background:linear-gradient(135deg,#1e40af,#3b82f6);min-height:100vh;display:flex;align-items:center;justify-content:center}
...
<body>
    <div class="container">
        <img src="<?= e($logo ?? '/assets/images/hidrossolo.png') ?>" alt="<?= e($app_name) ?>" class="logo">
        <div class="spinner"></div>
        <h1>Em Manutenção</h1>
        <p><?= e($message) ?></p>
        <div class="info">&copy; <?= e(date('Y')) ?> <?= e($app_name) ?>. Todos os direitos reservados.</div>
    </div>
</body>
</html>
