...
<head>
    ...
    <title>{{ $app_name }} - Em Manutenção</title>
...
<body>
    <div class="container">
        <img src="{{ $logo ?? '/assets/images/hidrossolo.png' }}" alt="{{ $app_name }}" class="logo">
        <div class="spinner"></div>
        <h1>Em Manutenção</h1>
        <p>{{ $message }}</p>
        <div class="info">&copy; {{ date('Y') }} {{ $app_name }}. Todos os direitos reservados.</div>
    </div>
</body>
</html>
