...
<section class="section">
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                <img src="{{ $page['featured_image'] ?? '/assets/images/empresa.jpg' }}" alt="Hidrossolo" class="img-fluid rounded-4 shadow">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card service-card h-100">
                    ...
                    <h3>Missão</h3>
                    <p>{{ $sectionContents['missao'] ?? 'Oferecer soluções sustentáveis em captação de água subterrânea, garantindo qualidade, segurança e satisfação dos nossos clientes.' }}</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card service-card h-100">
                    ...
                    <h3>Visão</h3>
                    <p>{{ $sectionContents['visao'] ?? 'Ser referência regional em perfuração de poços artesianos, reconhecida pela excelência técnica e responsabilidade ambiental.' }}</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card service-card h-100">
                    ...
                    <h3>Valores</h3>
                    <p>{{ $sectionContents['valores'] ?? 'Ética, transparência, compromisso com o meio ambiente, inovação constante e respeito às pessoas.' }}</p>
                </div>
            </div>
        </div>
    </div>
