...
<head>
    ...
    <style>
        ...
        body { font-family: var(--font-sans); background: #eef2f9; overflow-x: hidden; }
...
<body>
    ...
    <!-- Sidebar Off-Canvas -->
    <?= $view->partial('admin.components.sidebar') ?>
        ...
        <div class="topbar">
            ...
            <div class="user-menu">
                ...
                <a href="/admin/notificacoes" class="btn btn-light position-relative" title="Notificações">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"><?= e($unread_notifications) ?></span>
                </a>
                <?php } ?>
                <span class="text-muted d-none d-md-inline"><?= e($_SESSION['user_name'] ?? 'Usuário') ?></span>
                <div class="dropdown">
