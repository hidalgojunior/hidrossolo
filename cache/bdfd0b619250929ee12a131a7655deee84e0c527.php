...
<head>
    ...
    <meta name="description" content="<?php echo e($seo['description'] ?? 'Hidrossolo Poços Artesianos - Perfuração, limpeza e manutenção de poços artesianos em Marília e região. Mais de 15 anos de experiência.'); ?>">
    <meta name="keywords" content="<?php echo e($seo['keywords'] ?? 'poços artesianos, perfuração de poços, limpeza de poços, manutenção de poços, outorga, licenciamento, Hidrossolo, Marília'); ?>">
    <meta name="author" content="Hidrossolo Poços Artesianos">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large">
    <link rel="canonical" href="<?php echo e($app_url); ?><?php echo e($_SERVER['REQUEST_URI']); ?>">

    
    <meta property="og:site_name" content="<?php echo e($app_name); ?>">
    <meta property="og:title" content="<?php echo e($seo['title'] ?? $title ?? $app_name); ?>">
    <meta property="og:description" content="<?php echo e($seo['description'] ?? 'Especialistas em perfuração de poços artesianos e soluções hídricas sustentáveis.'); ?>">
    <meta property="og:url" content="<?php echo e($app_url); ?><?php echo e($_SERVER['REQUEST_URI']); ?>">
    <meta property="og:type" content="<?php echo e($og_type ?? 'website'); ?>">
    <meta property="og:image" content="<?php echo e($app_url); ?><?php echo e($logo ?? '/assets/images/hidrossolo.png'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e($seo['title'] ?? $title ?? $app_name); ?>">
    <meta name="twitter:description" content="<?php echo e($seo['description'] ?? 'Especialistas em perfuração de poços artesianos.'); ?>">
    <meta name="twitter:image" content="<?php echo e($app_url); ?><?php echo e($logo ?? '/assets/images/hidrossolo.png'); ?>">

    
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "<?php echo e($schema_type ?? 'LocalBusiness'); ?>",
        "name": "<?php echo e($app_name); ?>",
        "url": "<?php echo e($app_url); ?>",
        "logo": "<?php echo e($app_url); ?><?php echo e($logo ?? '/assets/images/hidrossolo.png'); ?>",
        "description": "<?php echo e($seo['description'] ?? 'Especialistas em perfuração de poços artesianos'); ?>",
        "address": {
            "@type": "PostalAddress",
    ...
    <title><?php echo e($seo['title'] ?? $title ?? $app_name); ?> | <?php echo e($app_name); ?></title>
...
<body>
    ...
    <?php echo $__env->make('components.whatsapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div id="cookie-banner" style="position:fixed;bottom:0;left:0;right:0;background:#1e293b;color:#e2e8f0;padding:1rem 2rem;z-index:9999;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;font-size:0.9rem;">
        <span style="flex:1;min-width:250px"><?php echo e($lgpdSettings['cookie_consent_text'] ?? 'Este site utiliza cookies para melhorar sua experiência. Ao continuar navegando, você concorda com nossa Política de Privacidade.'); ?></span>
...
<?php /**PATH /var/www/html/views/layouts/main.blade.php ENDPATH**/ ?>