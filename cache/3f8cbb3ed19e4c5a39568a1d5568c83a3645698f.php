...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value"><?php echo e($contatosNovos); ?></div>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value"><?php echo e($contratosAtivos); ?></div>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value"><?php echo e($totalVeiculos); ?></div>
            ...
            <div class="card-body p-0">
                ...
                <?php else: ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $ultimosContatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="/admin/contatos/<?php echo e($contato['id']); ?>" class="list-group-item list-group-item-action">
                            <div class="d-flex justify-content-between">
                                <strong><?php echo e($contato['name']); ?></strong>
                                <small class="text-muted"><?php echo e(date('d/m/Y H:i', strtotime($contato['created_at']))); ?></small>
                            </div>
                            <small class="text-muted"><?php echo e(Str::limit($contato['message'], 80)); ?></small>
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <?php else: ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $contratosVencendo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <strong><?php echo e($c['contract_number']); ?></strong> - <?php echo e($c['client_name']); ?>

                                </div>
                                <span class="badge bg-warning text-dark">Vence <?php echo e(date('d/m/Y', strtotime($c['end_date']))); ?></span>
                            </div>
                            <small class="text-muted">R$ <?php echo e(number_format($c['value'], 2, ',', '.')); ?></small>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>
...
new Chart(document.getElementById('chartManutencao'), {
    type: 'bar',
    data: { labels: <?php echo json_encode($labelsM, 15, 512) ?>, datasets: [{ label: 'Manutenções (R$)', data: <?php echo json_encode($dataM, 15, 512) ?>, backgroundColor: colors[0], borderRadius: 6 }] },
...
new Chart(document.getElementById('chartCombustivel'), {
    type: 'line',
    data: { labels: <?php echo json_encode($labelsC, 15, 512) ?>, datasets: [{ label: 'Combustível (R$)', data: <?php echo json_encode($dataC, 15, 512) ?>, borderColor: colors[4], backgroundColor: colors[4]+'20', fill: true, tension: 0.3 }] },
    options: { responsive: true, plugins: { legend: { display: false } } }
});
<?php endif; ?>
</script>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/views/admin/dashboard.blade.php ENDPATH**/ ?>