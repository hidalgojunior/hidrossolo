...
<div class="card"><div class="card-body">
    <form method="POST" action="/orcamento/enviar">
        ...
        <div class="row g-3">
            <div class="col-md-6"><label class="form-label">Nome *</label><input type="text" name="name" class="form-control" value="<?php echo e($_SESSION['old_input']['name'] ?? ''); ?>" required></div>
            <div class="col-md-6"><label class="form-label">E-mail *</label><input type="email" name="email" class="form-control" value="<?php echo e($_SESSION['old_input']['email'] ?? ''); ?>" required></div>
            <div class="col-md-6"><label class="form-label">Telefone</label><input type="text" name="phone" class="form-control" value="<?php echo e($_SESSION['old_input']['phone'] ?? ''); ?>"></div>
            ...
            <div class="col-12"><label class="form-label">Descreva o serviço *</label><textarea name="description" class="form-control" rows="4" required placeholder="Descreva o que você precisa..."><?php echo e($_SESSION['old_input']['description'] ?? ''); ?></textarea></div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/views/pages/orcamento.blade.php ENDPATH**/ ?>